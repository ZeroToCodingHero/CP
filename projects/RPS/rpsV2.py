...
player1 = input("player1, please enter 'R' for Rock, 'P' for Paper, or 'S' for Scissors: ").upper().strip()
player2 = input("player2, please enter 'R' for Rock, 'P' for Paper, or 'S' for Scissors: ").upper().strip()
